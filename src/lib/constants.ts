...
export const TABS: TabDef[] = [
  ...
  { k: "ops", label: "OPS QA", emoji: "\u{1F50E}", div: "OPS", dated: true, singular: "Lead", note: "OPS QA verifies documents and records a reasoning for every decision. Only DL Recd and Voided Check must be Yes to approve — Bank Stmt, owner, and business checks are optional. Approved sends it to Onboarding. Rework returns the deal to Documentation with your reasoning." },
