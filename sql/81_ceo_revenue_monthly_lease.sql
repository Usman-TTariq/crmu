-- ============================================================================
-- TGT Nexus CRM — 81_ceo_revenue_monthly_lease.sql
-- CEO "Funded lease volume" uses sum(monthly_lease) for Funded rows
-- (was approved_funding). Keeps dash_ceo timeframe filters from 64.
-- Safe to re-run.
-- ============================================================================
