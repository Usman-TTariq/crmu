-- ============================================================================
-- TGT Nexus CRM — 69_onboarding_attachments_carryforward.sql
-- Onboarding can see Closer / Docs / OPS documents (and attach its own).
-- Safe to re-run.
-- ============================================================================
...
alter table public.attachments
  ...
  check (stage in ('closer', 'ops', 'documentation', 'msp'));
