-- ============================================================================
-- TGT Nexus CRM — 65_hr_monitor_role.sql
-- Role hr_monitor: Employee Monitor only (full company board, like admin).
-- Safe to re-run after deploying app role_key=hr_monitor.
-- ============================================================================
...
as $$
  select private.is_admin()
      or private.role_key() in ('sales_head', 'ops_manager', 'hr_monitor');
$$;
...
as $$
  select exists (
    ...
    where p.user_id = p_user_id
      ...
      and p.role_key not in ('ceo', 'super_admin', 'hr_monitor')
      and (
        private.is_admin()
        or private.role_key() = 'hr_monitor'
        or (
...
-- Full board for hr_monitor (same as admin), keep sales_head / ops_manager scopes.
